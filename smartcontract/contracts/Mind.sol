...
contract MIND is ERC20, ERC20Burnable, Ownable {
    ...
    constructor() ERC20("NeuroWealth", "MIND") Ownable(msg.sender) {
        // Initial mint to deployer for distribution (FIXED)
        _mint(
            msg.sender,
            TEAM_ALLOCATION + TREASURY_ALLOCATION + LIQUIDITY_ALLOCATION
        );
    }
